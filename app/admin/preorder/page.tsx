      ...
      >
        {preview ? (
          ...
          <>
            <Upload
              size={20}
              className="text-zinc-600 group-hover:text-fuchsia-500 transition-colors"
            />
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2 mb-2">
        {tags.map((tag, idx) => (
          <div
            key={idx}
            className="flex items-center gap-2 bg-zinc-100 dark:bg-white/5 px-3 py-1.5 rounded-xl border border-zinc-200 dark:border-white/10 group transition-all hover:border-fuchsia-500/30"
          >
            <span className="text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-zinc-400 group-hover:text-fuchsia-500">
              {tag}
            </span>
            <button
              type="button"
...
function LandingCMS({
  ...
  const defaultData: LandingData = {
    hero: {
      ...
      headline: "ENGINEERED\nSILHOUETTE.",
      subheadline:
        "Raw industrial textures fused with high-end structural integrity. A new protocol for the aesthetic fringe.",
    ...
    categories: [
      {
        name: "Oversize",
        count: "12 Artifacts",
        img: "https://images.unsplash.com/photo-1571945153237-4929e783ee4a?q=80&w=800",
      },
      {
        name: "Graphic",
        count: "08 Artifacts",
        img: "https://images.unsplash.com/photo-1554568218-0f1715e72254?q=80&w=800",
      },
      {
        name: "Minimal",
        count: "05 Artifacts",
    ...
    preorder: {
      ...
      description:
        "We reject mass-production. Every piece is architected specifically for its owner.",
      ...
      steps: [
        {
          title: "01 SECURE",
          desc: "Place your order to secure your allocation.",
        },
        {
          title: "02 ARCHITECT",
          desc: "Your artifact enters the production phase.",
        },
        {
          title: "03 DEPLOYMENT",
          desc: "Your order is dispatched directly from our archive.",
        },
      ],
    },
    appearance: {
  ...
  const [formData, setFormData] = useState<LandingData>({
    ...
    hero: {
      ...defaultData.hero,
      ...data?.hero,
      image_urls: data?.hero?.image_urls?.length
        ? data.hero.image_urls
        : defaultData.hero?.image_urls || [],
    },
  ...
  const toggleVisibility = (id: string) => {
    const next = formData.sections?.map((s) =>
  ...
  return (
    <div className="space-y-8">
          ...
          <Card>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-400 font-bold uppercase italic mt-0.5">
                  Control the visual essence of your terminal.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: formData.appearance?.colors?.primary,
                    }}
                  />
                </div>
                <div className="flex gap-2">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className="w-4 h-4 rounded-full border border-zinc-200 dark:border-zinc-800"
                    style={{
                      backgroundColor: formData.appearance?.colors?.secondary,
                    }}
                  />
                </div>
                <div className="flex gap-2">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className="w-4 h-4 rounded-full border border-zinc-200 dark:border-zinc-800"
                    style={{
                      backgroundColor: formData.appearance?.colors?.accent,
                    }}
                  />
                </div>
                <div className="flex gap-2">
            ...
            <div className="mt-6 p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900">
              <p className="text-[10px] font-bold text-zinc-500 leading-relaxed italic">
                Note: Colors are injected as CSS variables throughout the
                application. Use curated HSL values for best results with dark
                mode filters.
              </p>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {formData.sections?.map((s, i) => (
                <div
                  key={s.id}
                  className="flex items-center justify-between p-3 rounded-xl border border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-zinc-900/40 overflow-hidden"
                >
                  ...
                  <div className="flex items-center flex-wrap gap-1.5 justify-end focus-within:ring-0">
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded-lg transition-colors ${s.visible ? "text-fuchsia-500 bg-fuchsia-500/10" : "text-zinc-400 bg-zinc-100 dark:bg-zinc-800"}`}
                    >
                      {s.visible ? (
      ...
      {formData.sections?.map((section) => {
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border transition-all ${section.visible ? "bg-fuchsia-500/10 text-fuchsia-500 border-fuchsia-500/20" : "bg-zinc-100 text-zinc-400 border-zinc-200"}`}
                  >
              ...
              <div className="mb-6 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  {formData.hero?.image_urls?.map((url, idx) => (
                    <div
                      key={idx}
                      className="relative group aspect-square rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-zinc-900/40"
                    >
                      <img
                        src={url}
                        alt={`Hero ${idx + 1}`}
                      ...
                      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <button
                          onClick={() => {
                            const nextUrls = formData.hero?.image_urls?.filter(
                              (_, i) => i !== idx,
                            );
                            handleChange("hero", {
                              ...formData.hero,
        ...
        if (section.id === "featured_products")
          return (
            ...
            <Card key="featured_products">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
                  ...
                  <button
                    onClick={() => moveSection("featured_products", "up")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="rotate-45" size={14} />
                  </button>
                  <button
                    onClick={() => moveSection("featured_products", "down")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="-rotate-[135deg]" size={14} />
                  </button>
                  ...
                  <button
                    onClick={() => toggleVisibility("featured_products")}
                    className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border transition-all ${section.visible ? "bg-fuchsia-500/10 text-fuchsia-500 border-fuchsia-500/20" : "bg-zinc-100 text-zinc-400 border-zinc-200"}`}
                  >
              ...
              <div className="mb-4">
                <p className="text-[10px] text-zinc-500 font-bold uppercase italic">
                  Select artifacts to display in "The New Season" vault.
                </p>
              </div>
            ...
            <Card key="categories">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
                  ...
                  <button
                    onClick={() => moveSection("categories", "up")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="rotate-45" size={14} />
                  </button>
                  <button
                    onClick={() => moveSection("categories", "down")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="-rotate-[135deg]" size={14} />
                  </button>
              ...
              <div className="space-y-4">
                {formData.categories?.map((cat: any, i: number) => (
                  <div
                    key={i}
                    className="p-4 border border-zinc-200 dark:border-zinc-800 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 relative"
                  >
                    <button
                      type="button"
                      onClick={() => {
          ...
          return (
            ...
            <Card key="lookbook">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
                  <button
                    onClick={() => moveSection("lookbook", "up")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="rotate-45" size={14} />
                  </button>
                  <button
                    onClick={() => moveSection("lookbook", "down")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="-rotate-[135deg]" size={14} />
                  </button>
                  ...
                  <button
                    onClick={() => toggleVisibility("lookbook")}
                    className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border transition-all ${section.visible ? "bg-fuchsia-500/10 text-fuchsia-500 border-fuchsia-500/20" : "bg-zinc-100 text-zinc-400 border-zinc-200"}`}
                  >
                    {section.visible ? "VISIBLE" : "HIDDEN"}
                  </button>
          ...
          return (
            ...
            <Card key="preorder">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
                  <button
                    onClick={() => moveSection("preorder", "up")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="rotate-45" size={14} />
                  </button>
                  <button
                    onClick={() => moveSection("preorder", "down")}
                    className="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg text-zinc-500"
                  >
                    <FiPlus className="-rotate-[135deg]" size={14} />
                  </button>
                  ...
                  <button
                    onClick={() => toggleVisibility("preorder")}
                    className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border transition-all ${section.visible ? "bg-fuchsia-500/10 text-fuchsia-500 border-fuchsia-500/20" : "bg-zinc-100 text-zinc-400 border-zinc-200"}`}
                  >
                    {section.visible ? "VISIBLE" : "HIDDEN"}
                  </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (!isNaN(date.getTime())) {
                        handleChange("preorder", {
                          ...formData.preorder,
                          countdown_target: date.toISOString(),
                        });
                      }
                    }}
                  />
                ...
                <div className="md:col-span-2">
                  <TagInput
                    ...
                    onChange={(sizes) =>
                      handleChange("preorder", { ...formData.preorder, sizes })
                    }
                  />
                </div>
                <div className="md:col-span-2">
...
function LegalCMS({
  ...
  data: LegalData;
  onSave: (d: LegalData) => void;
}) {
  const [formData, setFormData] = useState<LegalData>(data);
  const [activeSubTab, setActiveSubTab] = useState<"terms" | "privacy">(
    "terms",
  );
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  value={section.title}
                  onChange={(e) =>
                    handleChange(activeSubTab, idx, "title", e.target.value)
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleChange(activeSubTab, idx, "content", e.target.value)
                  }
...
export default function AdminPreorder() {
  ...
  const fetchData = useCallback(async () => {
    ...
    const { data: settings } = await supabase
      .from("site_settings")
      .select("*")
      .in("key", ["landing_content", "preorder", "legal_content"]);

    const settingsMap =
      settings?.reduce((acc: any, curr: any) => {
      ...
      <div className="max-w-7xl mx-auto overflow-hidden">
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="overflow-hidden">
            ...
            <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mt-2 px-1 truncate">
        ...
        <AnimatePresence mode="wait">
          {activeTab === "landing" ? (
            ...
            >
              {landingData ? (
                <LandingCMS data={landingData} onSave={handleSaveLanding} />
              ) : (
            ...
            >
              {legalData ? (
                <LegalCMS data={legalData} onSave={handleSaveLegal} />
              ) : (
                <div className="py-20 flex justify-center">
                  <FiRefreshCw className="animate-spin" />
                </div>
              ...
              {productLoading && !product ? (
                ...
                <div className="py-32 text-center border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-[3rem] bg-white dark:bg-zinc-950 shadow-sm">
                  ...
                  <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest mb-8">
                    This campaign currently has no associated product artifact.
                  </p>
                ...
                <form
                  ...
                  className="bg-white dark:bg-zinc-900 p-10 rounded-[3rem] border border-zinc-200 dark:border-zinc-800 shadow-xl space-y-8"
                >
                  <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-6 mb-2">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-fuchsia-500/10 flex items-center justify-center">
                        <FiBox size={24} className="text-fuchsia-500" />
                      </div>
                      <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        {[0, 1, 2, 3, 4, 5].map((idx) => {
                          const url =
                            product.image_urls?.[idx] ||
                            (idx === 0 ? product.image_url : null);
                          return (
                            <div
                              key={idx}
                              className="aspect-square bg-zinc-50 dark:bg-zinc-950 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 relative group"
                            >
                              {url ? (
                                <>
                                  <img
                                ...
                                <label className="inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors">
                                  ...
                                  />
                                  <span className="text-[8px] font-black uppercase text-zinc-400 text-center block w-full">
                                    Add Slot {idx + 1}
                                  </span>
                                  <input
                                    type="file"
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800 px-4 py-3 rounded-xl text-xs font-bold outline-none focus:border-fuchsia-500/50"
                          />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800 px-4 py-3 rounded-xl text-xs font-bold font-mono"
                            />
                          </div>
                          <div>
                            <label className="text-[8px] font-black uppercase text-zinc-500 mb-1 block">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800 px-4 py-3 rounded-xl text-xs font-bold outline-none focus:border-fuchsia-500/50 resize-none"
                          />
                        </div>
                        <TagInput
                          label="Available Sizes"
                  ...
                  <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800">
                    <button
                      ...
                      className="w-full py-5 bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:shadow-2xl transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                    >
                      {productLoading ? (
                        <FiRefreshCw className="animate-spin" />
                      ) : (
              ...
              <div className="space-y-4">
                {loading && orders.length === 0 ? (
                  ...
                  orders.map((order) => (
                    <div
                      key={order.id}
                      className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 flex items-center justify-between group hover:border-fuchsia-500/30 transition-all shadow-sm"
                    >
                      <div className="flex items-center gap-6">
                        <div className="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                          <FiShoppingBag className="text-fuchsia-500" />
                        </div>
                        <div>
                          <p className="text-[11px] font-black uppercase truncate max-w-[150px]">
                            {order.customer_name}
                          </p>
                      ...
                      <div className="text-right">
                        <p className="text-[10px] font-black italic mb-1">
                          IDR {Number(order.total_price).toLocaleString()}
                        </p>
                        <span
                          className={`px-3 py-1 text-[8px] font-black uppercase tracking-widest rounded-full border ${order.status === "paid" ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20" : "bg-zinc-500/10 text-zinc-500 border-zinc-500/20"}`}
                        >
                          {order.status}
                        </span>
                      </div>
