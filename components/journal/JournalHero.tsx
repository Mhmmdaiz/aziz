        ...
        <div className="flex flex-col gap-12 lg:gap-20">
          ...
          <div className="space-y-6">
            <motion.nav 
              ...
              className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 italic"
            >
              <span>Daemonium_Archive</span>
              <span className="w-1 h-1 bg-red-600 rounded-full animate-pulse" />
              <span className="text-white">Editorial_Journal</span>
            </motion.nav>
            ...
            <motion.h1 
              ...
              className="text-6xl md:text-9xl font-black italic uppercase tracking-tighter leading-[0.8] text-white"
            >
              Stories<br />
          ...
          <motion.div 
            ...
            className="group relative grid lg:grid-cols-2 bg-zinc-900/50 backdrop-blur-3xl border border-white/5 rounded-[3rem] overflow-hidden hover:border-red-500/20 transition-all duration-700 shadow-2xl"
          >
            <div className="relative aspect-video lg:aspect-auto overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-zinc-900/80 to-transparent lg:hidden" />
            </div>
            ...
            <div className="p-8 md:p-16 flex flex-col justify-center gap-8 relative">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter leading-tight text-white group-hover:text-red-500 transition-colors duration-500">
              ...
              <Link 
                ...
                className="group/btn self-start px-10 py-5 bg-white text-black rounded-full font-black uppercase text-[10px] tracking-widest hover:bg-red-600 hover:text-white transition-all transform hover:scale-105 active:scale-95 flex items-center gap-4"
              >
