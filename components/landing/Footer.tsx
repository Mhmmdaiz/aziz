    ...
    <footer className="bg-white dark:bg-[#050505] text-black dark:text-white pt-24 pb-12 transition-colors duration-500 border-t border-zinc-100 dark:border-zinc-900">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-zinc-500 text-sm italic font-medium leading-relaxed max-w-xs">
              Architectural precision in streetwear. Elevating everyday utility
              with avant-garde aesthetics since SS/24.
            </p>
          ...
          {/* Navigation */}
          <div className="space-y-8">
            <h5 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 italic">
              Navigation
            </h5>
            <ul className="space-y-4">
              {[
                ...
                <li key={item}>
                  <Link
                    href="/shop"
                    className="text-sm font-bold uppercase tracking-widest text-zinc-400 hover:text-red-500 transition-colors flex items-center gap-2 group"
                  >
        ...
        <div className="pt-12 border-t border-zinc-100 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] font-black uppercase tracking-[0.3em] text-zinc-400">
          <p>
            © {new Date().getFullYear()} DAEMONIUM_ARCHIVE SYSTEM. ALL RIGHTS
            RESERVED.
          </p>
