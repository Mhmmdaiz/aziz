    ...
    <aside className="w-full space-y-12 sticky top-32">
       ...
       <section className="space-y-6">
          <div className="flex items-center gap-3">
             ...
             <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">Class_Category</h3>
          </div>
       ...
       <section className="space-y-6">
          <div className="flex items-center gap-3">
             ...
             <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">Value_Threshold</h3>
          </div>
       ...
       <section className="space-y-6">
          <div className="flex items-center gap-3">
             ...
             <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">Dimension_Grid</h3>
          </div>
